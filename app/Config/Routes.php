...
$routes->get('/user/editProject/(:num)', 'ProjectController::edit/$1');
$routes->match(['get','post'], '/user/editProject/update/(:num)','ProjectController::update/$1');
...
$routes->match(['get','post'], '/user/editTask/update/(:num)','TaskController::update/$1');
...
$routes->match(['get','post'], '/user/editSubtask/update/(:num)','SubtaskController::update/$1');
